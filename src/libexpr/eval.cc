...
void EvalState::mkOutputString(Value &value, const StorePath &drvPath,
  ...
  value.mkString(
      optOutputPath
          ...
          : DownstreamPlaceholder::unknownCaOutput(drvPath, outputName)
                .render(),
      NixStringContext{NixStringContextElem::Built{
          .drvPath = drvPath,
          .output = outputName,
      }});
}
...
std::pair<DerivedPath, std::string_view>
EvalState::coerceToDerivedPathUnchecked(const PosIdx pos, Value &v,
                                        std::string_view errorCtx) {
  NixStringContext context;
...
DerivedPath EvalState::coerceToDerivedPath(const PosIdx pos, Value &v,
                                           std::string_view errorCtx) {
